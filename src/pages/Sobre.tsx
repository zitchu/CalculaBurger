            ...
            <Parallax className='bg-black animation' pages={2} style={{ top: '0', left: '0' }}>
                ...
                <ParallaxLayer offset={1} speed={2}>
                    ...
                    <div className='basis-6/12 pb-4 mb-4 h-full'>
                        ...
                        <p className="text-justify py-2 leading-8">
                        Por juntar meu treinamento em programação, principalmente focado no frontend, e minha paixão por fazer hamburgueres caseiros,
                        decidi compartilhar minha calculadora base para compras baseadas no número de pessoas com cada perfil. É um projeto pessoal que toma
